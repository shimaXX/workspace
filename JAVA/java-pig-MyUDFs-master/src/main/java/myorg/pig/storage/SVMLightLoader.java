...
public class SVMLightLoader extends LoadFunc {
    ...
    public Tuple getNext() throws IOException {
        try {
            ...
            if (! nextExist) {
                return null; //データが存在しなければnullを返す
            }
            ...
            mProtoTuple = null;
            return t; //key, valueの組みをtupleに入れたモノを返す
    ...
    public class SVMLightRecordReader extends RecordReader<String, HashMap<String, Float>> {
        ...
        public boolean nextKeyValue() throws IOException, InterruptedException {
            try {
                ...
                StringTokenizer st = new StringTokenizer(value.toString(), " "); //valueをスペースでcut。スペースで区切られたモノがkey,valueのペアとなる

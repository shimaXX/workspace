...
%default PATH_OUTPUT 'works/output/GAMIFICATION/EVA/GetEntryPriorVerb1107';
...
--(3) EVAに絞る
FilteredData = FILTER EditData BY cid == 3 AND time > '$EXSTART_DATE' AND time < '$EXLAST_DATE';
